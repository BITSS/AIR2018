...
We want to estimate the probability of at least two people, among the  `r n.pers`  in this room,  having the same birthday. 
...
The simulated probability is `r birthday.prob(n.pers.param,n.sims.param)` 