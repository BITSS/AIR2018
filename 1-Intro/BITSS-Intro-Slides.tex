...
\title[Credibility Crisis and some Solutions] % (optional, use only with long paper titles)
{Credibility Crisis and some Solutions: Registration and Pre-Analysis Plans}
...
Slides available online at \url{https://github.com/BITSS/AIR2018}}
...
\begin{frame}{Suggested Items (Mckenzie, 2012)}
...
\item Read the manual Garret wrote.\href{https://github.com/garretchristensen/BestPracticesManual}{\beamergotobutton{Link}}
